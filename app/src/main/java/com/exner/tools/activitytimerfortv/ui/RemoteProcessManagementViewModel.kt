...
import com.exner.tools.activitytimerfortv.network.GenericProcess
import com.exner.tools.activitytimerfortv.network.RemoteProcessData
import com.exner.tools.activitytimerfortv.network.RemoteProcessesService
import com.exner.tools.activitytimerfortv.network.createTimerProcessFrom
                    ...
                    override fun onResponse(
                        ...
                        if (response.code() == 200) {
                            ...
                            val meditationTimerProcess =
                                createTimerProcessFrom(genericProcess)
                            runBlocking {
